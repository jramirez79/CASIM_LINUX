...
//=======================================================================================
//
bool CharacterGroup::genCharacterModel( VboManager* vbo_manager, GlslManager* glsl_manager )
{
...
//<-PATTERNS
	...
	{
		log_manager->log( LogManager::INFORMATION, "\t\t[%d]\t%s", g, StringUtils::getNameFromPath( (char*)globalMtNames[g].c_str() ) );
	}

	log_manager->log( LogManager::INFORMATION, "\tTORSO:" );
	for( unsigned int t = 0; t < torsoMtNames.size(); t++ )
	{
		log_manager->log( LogManager::INFORMATION, "\t\t[%d]\t%s", t, StringUtils::getNameFromPath( (char*)torsoMtNames[t].c_str() ) );
	}

	log_manager->log( LogManager::INFORMATION, "\tLEGS:" );
	for( unsigned int l = 0; l < legsMtNames.size(); l++ )
	{
		log_manager->log( LogManager::INFORMATION, "\t\t[%d]\t%s", l, StringUtils::getNameFromPath( (char*)legsMtNames[l].c_str() ) );
	}
}
//
//=======================================================================================
...
void CharacterGroup::genFacialMultitexture( void )
{
	...
	{
		log_manager->log( LogManager::INFORMATION, "\t[%d]\t%s", f, StringUtils::getNameFromPath( (char*)facialMtNames[f].c_str() ) );
	}
}
//
//=======================================================================================
...
void CharacterGroup::genRiggingMultitexture( void )
{
	...
	{
		log_manager->log( LogManager::INFORMATION, "\t[%d]\t%s", r, StringUtils::getNameFromPath( (char*)riggingMtNames[r].c_str() ) );
	}
}
//
//=======================================================================================
